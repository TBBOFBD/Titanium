...
impl From<u64> for Keyboard {
    // https://www.cl.cam.ac.uk/~mgk25/ucs/keysymdef.h
    // https://github.com/AltF02/x11-rs/blob/master/src/keysym.rs
    fn from(code: u64) -> Keyboard {
        match code {
            0xFF08 => BackspaceKey,
            0xFF09 => TabKey,
            0xFF8D => EnterKey,
...
pub fn scan_code_to_key(scan_code: u32) -> Option<Keyboard> {
    match scan_code {
...
// https://www.win.tue.nl/~aeb/linux/kbd/scancodes-1.html
pub fn key_to_scan_code(key: Keyboard) -> i32 {
    match key {
        BackspaceKey => 0x0E,
        TabKey => 0x0F,
        EnterKey => 0x1C,
